...
for (i in seq_along(months)) {
  ...
  assign(paste0("srad_sum_", month1, month2), srad_sum)
...
dayl_mean <- aggregate(df_final$dayl..s.[month_rows], list(df_final$loc[month_rows], df_final$year[month_rows]), FUN = mean) %>%
  ...
  assign(paste0("dayl_mean_", month1, month2), dayl_mean)
...
for (i in seq_along(months)) {
  ...
  assign(paste0("srad_sum_", month1, month2, month3, month4), srad_sum)
  ...
  assign(paste0("dayl_mean_", month1, month2, month3, month4), dayl_mean)
