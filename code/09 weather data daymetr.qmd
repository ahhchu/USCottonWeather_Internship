...
```{r every 4 months}
months <- c(4, 8)
four_combined <- monthly_combined  # Create an initial data frame with columns from growing_season_combined_data
...
```{r twice_combined}
write.csv(twice_combined, "data/daymet/weatherDataDaymetr.csv")
