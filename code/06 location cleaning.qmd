...
# to show distinct location and loccodes
```{r}
loc_q <- df_q %>%
...
```{r}
combined <- inner_join(df_c, df_q, by = c("year" = "yr", "loc", "loccode", "rep", "reg", "irrigation", "breeder", "sample", "var"))
write_xlsx(combined, "output/cleaned/combined_Coordinates_Quality.xlsx")
```
