...
# plot for actual VS predicted valuesp (point=test_data)
 save <- plot_data %>%
  ...
  ggtitle("All Temporal: Actual vs. Predicted") + 
...
ggsave(path = "figs", "poster_actualVSpredicted.png", plot=save, width=8.5, height=12, units = "in") 
...
ggsave(path = "figs", "monthly_poster_actualVSpredicted.png", plot=save_monthly, width=8.5, height=12, units = "in") 
